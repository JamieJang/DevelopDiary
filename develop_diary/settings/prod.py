...
STATICFILES_STORAGE = 'develop_diary.storages.StaticS3Boto3Storage' 
DEFAULT_FILE_STORAGE = 'develop_diary.storages.MediaS3Boto3Storage'
# S3 파일 관리에 필요한 최소 설정
